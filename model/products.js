...
// defining model **remember, model first argument will be your collection name and always should be in first letter capital and in plural form for instance:- if my collection name is "meows" than the argument should be "Meow" or "cats" as "Cat"
